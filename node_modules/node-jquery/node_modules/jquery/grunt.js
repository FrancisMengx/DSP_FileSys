module.exports = function(grunt) {
  ...
  var exec = require('child_process').exec,
      ...
      jqPath = '/ajax/libs/jquery/1.8.3/jquery.min.js';
  ...
  grunt.registerTask('build', 'builds jquery module for us in nodjs', function() {
    ...
    function buildjQuery(jq) {
      ...
      fs.writeFileSync('./lib/node-jquery.min.js', wrapper);
      done();
    }
    ...
    function writejQuery() {
      var data = '',
        ...
        res.on('end', function() {
          fs.writeFileSync(tmpDir+'/jquery.min.js', data);
          buildjQuery(data);
        });
      });
      req.write('data\n');
    ...
    function getjQuery() {
      var jq = null;
      try {
        jq = fs.readFileSync(tmpDir+'/jquery.min.js', 'utf8');
        buildjQuery(jq);
      } catch (e) {
        writejQuery();
      }
