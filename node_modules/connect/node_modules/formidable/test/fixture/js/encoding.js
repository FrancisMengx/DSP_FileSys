module.exports['menu_seperator.img.http'] = [
  {type: 'file', name: 'image', filename: 'menu_separator.img', fixture: 'menu_separator.img',
  sha1: 'c845ca3ea794be298f2a1b79769b71939eaf4e54'}
];

module.exports['beta-sticker-1.img.http'] = [
  {type: 'file', name: 'sticker', filename: 'beta-sticker-1.img', fixture: 'beta-sticker-1.img',
